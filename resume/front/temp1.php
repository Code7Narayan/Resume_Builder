...
<html lang="">
  ...
  #resume{
    ...
    background-color: rgb(244,244,100);
        ...
        #ns{
          text-align: ;
           ...
           height: 160px;
           width: 140px;
           box-shadow: 0px 7px 2px 4px rgb(128,128,128);
           
           
           margin: 0px;
          }
           #part1{
            background-color: rgb(244,000,100);
...
$exp=mysqli_fetch_array($res);
         ...
         <div id="resume">
           ...
           <div class="page-header" style="text-align:center;">
             <h1><?php echo $pros[1];?><small></small></h1>
           </div>
           <div>
                ...
                <!----------------prosnal------->
                <h3 style="text-align:center;">PROSNAL INFO:-</h3>
                ...
                <h3 style="text-align:center;">PROJECTS INFO:-</h3>
                <div>
                ...
                <h3 style="text-align:center;">EXPERIENCE INFO:-</h3>
                <div>
